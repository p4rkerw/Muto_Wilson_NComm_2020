...
Raw sequencing files and metadata can also found on the Human Cell Atlas data portal <br/>
The humancellatlas repository does not have the snATAC index fastq, which are only available in GSE151302: <br/>
